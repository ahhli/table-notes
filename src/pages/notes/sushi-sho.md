...
courses:
  ...
  - { id: engawa, zh: 赤身与缘侧, en: Akami & engawa }
...
<figure class="photo-slot"><div><span>01</span><small>PHOTO · CHAWANMUSHI</small></div><figcaption>蛋面平整无孔，火候准确；问题不在蒸，而在出汁。</figcaption></figure>
...
<h2 id="tomato">三色番茄：整晚最聪明的一次北欧表达</h2>

真正让我开始改观的，反而是一道看似简单的番茄。

盘中用了三种不同颜色的番茄，上面覆盖番茄做成的清凉 jelly，再点缀极细的紫苏丝。整道菜清爽、开胃，也有足够的鲜味，并不只是单纯用酸刺激味蕾。

它在菜单里的位置尤其漂亮。经过前面蛋黄、金枪鱼、三文鱼和较重调味以后，这道番茄像一次完整的味觉重置，为后面的赤身与肥美鱼类重新打好了基础。

它让我想到寿司席间的生姜：功能相似，表达方式却完全不同。这也是我最认可的“北欧融合”——不是在日料上强行堆放当地元素，而是理解一道传统配角为什么存在，再用本地食材重新实现同样的功能。

<figure class="photo-slot photo-slot--light"><div><span>02</span><small>PHOTO · TOMATO / SHISO</small></div><figcaption>不是复制生姜，而是用本地语言完成同一次味觉重置。</figcaption></figure>
...
<figure class="photo-slot"><div><span>03</span><small>PHOTO · NORDIC SHRIMP</small></div><figcaption>当地食材自己说话，才是最有说服力的地域表达。</figcaption></figure>

<h2 id="engawa">Akami 与炙烤 Engawa：后半程渐入佳境</h2>

经过番茄清口以后，后面一贯 akami 的状态明显更好。这次没有吃到前面那种令人不悦的血酸味。鱼肉处理得更干净，表面的轻度调味也没有抢戏，赤身与赤酢的发酵香终于形成了自然连接。

紧接着的 aburi engawa 也完成得相当扎实。比目鱼缘侧厚切后炙烤，表层脂肪迅速融化，带出焦化香气，内部依然保留胶质、弹性和纤维感。最后刷上的酱汁很薄，只提供一点甜咸，没有把鱼淹没。
...
<figure class="photo-slot photo-slot--toro"><div><span>04</span><small>PHOTO · TORO NIGIRI</small></div><figcaption>看见的鱼，当场下刀，最后成为面前的两贯。</figcaption></figure>
...
但进入握寿司阶段以后，厨师的基本功逐渐显现。赤酢饭有清楚的性格，刀工和调味也开始变得克制。Nordic shrimp、番茄清口、后段的 akami、aburi engawa，以及最后的 toro nigiri，都是值得记住的表现。
